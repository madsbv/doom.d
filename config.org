...
;; TODO: Consider enabling treesitter integration:
;; https://github.com/emacs-rustic/rustic?tab=readme-ov-file#tree-sitter
...
#+end_src
*** yaml
yaml-ts-mode is just bad for some reason, and doesn't respect indent settings.
#+begin_src emacs-lisp :tangle yes
