...
#+end_src
*** latex
For some reason this doesn't entirely work. It seems to set the correct mode, but not all features work as expected unless `LaTeX-mode` is called manually.
...
#+begin_src emacs-lisp :tangle yes
(add-to-list 'apheleia-mode-alist '(web-mode . lsp) )
(add-to-list 'apheleia-mode-alist '(html-mode . lsp) )
(add-to-list 'apheleia-mode-alist '(html-ts-mode . lsp) )
(add-to-list 'apheleia-formatters '(rustfmt "rustfmt" "--quiet" "--edition" "2024" "--emit" "stdout") )
#+end_src
*** rust
...
;; NOTE: I forgot why I added this, if something breaks, consider turning smartparens back off.
