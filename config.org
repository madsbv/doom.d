...
- latex
  - Set reftex bibliography and pdf file locations
  - Choose pdf viewer and set up
  - Set up cdlatex and org-cdlatex
- ledger
  - Copy over whatever legacy config is relevant
...
(after! org (org-defkey org-cdlatex-mode-map "`" 'cdlatex-math-symbol))
;; add symbols
