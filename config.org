#+title: Config
* TODO Initial notes
** TODO Doom modules to check flags and config options for while transferring old config
- snippets
...
- lookup
** TODO Keybindings
My Yabai keybindings on alt conflict a lot with Emacs. Consider moving to cmd, freeing up native MacOS keybindings as needed.
